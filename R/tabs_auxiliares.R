...
pesquisar_ncm <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product/ncm', query = params, config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_sh6 <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/harmonized-system/subposition', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_sh4 <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/harmonized-system/position', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_sh2 <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/harmonized-system/chapter', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_ncm_sec <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/harmonized-system/section', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_pais <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/location/countries', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_blocos <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/location/blocks', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_uf <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/location/states', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_mun <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/location/cities', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_via <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/location/via', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_urf <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/location/urf', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_cgce3 <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product-description/cgce-n3', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_cgce2 <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product-description/cgce-n2', query = params, config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_cgce1 <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product-description/cgce-n1', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_cuci_item <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product-category/item', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_cuci_sub <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product-category/subposition', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_cuci_pos <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product-category/position', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_cuci_cap <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product-category/chapter', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_cuci_sec <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product-category/section', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_isic_classe <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product-classification/class', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_isic_grupo <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product-classification/group', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_isic_div <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product-classification/division', query = params,config = httr::config(ssl_verifypeer = 0L))
...
pesquisar_isic_sec <- function(pattern='') {
  ...
  #Faz a requisição
  pesquisa <- httr::GET(url = 'http://api-comexstat.mdic.gov.br/pt/product-classification/section', query = params,config = httr::config(ssl_verifypeer = 0L))
